...
namespace NinjaTrader.Indicator
{
	...
	public class Pivots : Indicator
	{
		...
		{
			Add(new Plot(Color.Black,	 "PP "+PivotRangeType));
            Add(new Plot(Color.Blue, "R1 " + PivotRangeType));
            Add(new Plot(Color.Red, "S1 " + PivotRangeType));
            Add(new Plot(Color.Blue, "R2 " + PivotRangeType));
            Add(new Plot(Color.Red, "S2 " + PivotRangeType));
            Add(new Plot(Color.Blue, "R3 " + PivotRangeType));
            Add(new Plot(Color.Red, "S3 " + PivotRangeType));
